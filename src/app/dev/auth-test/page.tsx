		...
		<main
			...
			<div className="h-fit w-full flex flex-col justify-center items-center">
				<a
					...
					className="text-center text-4xl font-black mt-2 text-blue-400 border-2 border-blue-500 border-solid cursor-pointer w-fit p-1 pl-2 pr-2 rounded-lg hover:bg-blue-900 transition-all">
					Return to DEV
				</a>
				<div className="w-full h-full flex flex-row items-start justify-center pl-10 pr-10 gap-10 mt-10 flex-wrap">
					<div className="border-[1px] rounded-xl border-white border-solid p-2 w-96 flex flex-col items-center mt-1">
						...
						<input
							type="number"
							placeholder="Enter some id (will be autogenerated)"
							value={id || ""}
							onChange={(e) => setId(Number(e.target.value))}
							className="mt-5 rounded-lg w-11/12 h-10 text-white bg-gray-800 pl-3 pr-5 outline-none text-xl"
						/>
						<input
							type="password"
						...
						<div
							...
							className="mt-5 p-2 bg-gray-800 rounded-md text-2xl text-white cursor-pointer hover:bg-gray-700 select-none">
							Generate
						</div>
						<p className="text-white mt-5 p-2 bg-black rounded-md">
							{token}
						</p>
					</div>
					<div className="border-[1px] rounded-xl border-white border-solid p-2 w-96 flex flex-col items-center mt-1">
