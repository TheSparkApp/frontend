			...
			<div className="flex-1 flex items-center justify-center">
				<div className="w-full max-w-sm">
					<div className="text-center">
						<h1 className="text-4xl font-bold" style={{ color: theme?.theme.colors.text }}>
							Login
						</h1>
					</div>
					<div className="mt-4">
						<form>
							<motion.div variants={inputVariants} initial="rest" animate={usernameFocus ? "focus" : "rest"}>
								<label htmlFor="username" className="block text-sm font-medium" style={{ color: theme?.theme.colors.text }}>
									Username
								</label>
								<input
									type="text"
							...
							<motion.div variants={inputVariants} initial="rest" animate={passwordFocus ? "focus" : "rest"}>
								<label htmlFor="password" className="block text-sm font-medium" style={{ color: theme?.theme.colors.text }}>
									Password
								</label>
