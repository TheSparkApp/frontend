            ...
            <main className='w-full h-screen flex flex-col overflow-hidden'>
                ...
                <div className='bg-gray-500 w-full h-fit flex flex-col items-center overflow-y-scroll'>
                    <div className='flex flex-row mt-10 ml-10 select-none'>
                        ...
                        <div className='-translate-y-3'><LOGO width='320px' height='120px' white={true} /></div>
                    </div>
                            ...
                            <div className='flex flex-row flex-wrap -mt-4 justify-center'>
                                <div className='flex flex-col mt-5 mr-16 opacity-75 select-none'>
                                    ...
                                    <div className='flex flex-col text-sm mt-1 max-w-[300px] text-white'>
                                        <span>
                                        Spark is designed for speed, offering fast and efficient data processing capabilities. 
                                        With optimized algorithms and state-of-the-art technology, Spark handles large volumes of data quickly and effectively. 
                                        This allows you to access and manipulate your data in real time, ensuring a smooth and responsive experience. 
                                        Whether you're running complex computations or managing extensive datasets, Spark's performance-oriented architecture delivers 
                                        quick results.
                                        </span>
                                    </div>
                                </div>
                                <div className='flex flex-col mt-5 mr-16 opacity-75 select-none'>
                                    ...
                                    <div className='flex flex-col text-sm mt-1 max-w-[300px] text-white'>
                                        <span>
                                            Spark ensures the safety of your data by employing advanced encryption methods and secure connections. 
                                            Your information is safeguarded during transmission and storage, adhering to strict security standards to 
                                            maintain confidentiality and integrity. With Spark, you can have peace of mind knowing that your data is 
                                            protected from unauthorized access and potential breaches.
                                        </span>
                                    </div>
                                </div>
                                <div className='flex flex-col mt-5 mr-16 opacity-75 select-none'>
                                    ...
                                    <div className='flex flex-col text-sm mt-1 max-w-[300px] text-white'>
                                        <span>
                                        Spark is user-friendly, offering an intuitive interface and seamless integrations tailored to your social networking needs. 
                                        With easy-to-understand tools, Spark makes it simple to manage your feeds and connect with friends, classmates and family. 
                                        The sophisticated design, which you can also customise, ensures a smooth, hassle-free experience as you share and interact with content. 
                                        Enjoy personalised recommendations and features that enhance your social media experience on Spark.
                                        </span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className='bg-gray-800 pb-5 pt-2 w-full mt-2 flex-col flex items-center'>
                        <div className='w-11/12 max-w-[1200px] h-full flex flex-row'>
                            <img className='min-w-[300px] max-w-[300px] min-h-[300px] max-h-[300px]' src='https://static.vecteezy.com/system/resources/previews/008/850/474/original/3d-render-mobile-phone-png.png'></img>
                            <div className='ml-3 mr-5 flex flex-row items-center'>
                                <span className='font-semibold text-3xl text-white'><p className='text-5xl font-bold italic'>SPARK</p> is user-friendly, offering an intuitive interface and seamless integrations tailored to your social networking needs.</span>
                            </div>
                        </div>
                    </div>
                    <div className='bg-gray-800 pb-5 pt-2 w-full mt-2 flex-col flex items-center'>
                        <div className='w-11/12 max-w-[1200px] h-full flex flex-col justify-center items-start'>
                            ...
                            <div className='flex-row flex justify-center items-center'>
                                ...
                                <a href='mailto:spark-org@dxby.dev' className='ml-5 font-semibold text-blue-300 italic text-3xl'>spark-org@dxby.dev</a>
                            </div>
